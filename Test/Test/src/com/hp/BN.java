...
public class BN {
	    ...
	    if (number % 100 < 20) { 
	       ...
	       // return words[number] + " hundred " + thousandWord; 
	        return words[number] + " hundred and" + thousandWord;
	    }
       ...
       System.out.println(" convertNumberToWord");
	        ...
	        String snumber = Long.toString(number); 
                System.out.println(" snumber.length()="+snumber.length());
	    ...
	    System.out.println("millions="+millions+" hundredThousands="+hundredThousands+" thousands="+thousands);
	   /*     String wordBillions; 
	        switch (billions) { 
	        case 0: 
	            wordBillions = ""; 
...
*/
	        ...
	        int x=Integer.parseInt(snumber.substring(0, 3)); 
