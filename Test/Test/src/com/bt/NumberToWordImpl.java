...
public class NumberToWordImpl implements NumberToWord
 {
	...
	/*	else
		{
			throw new Exception(" you can't have second instance of words initilisation");
		}
	*/			
	 }
	...
	{ System.out.println("convertLessThanOneThousand- tensWords="+tensWords.hashCode());
	System.out.println("convertLessThanOneThousand- tensWords="+words.hashCode());
